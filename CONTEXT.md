...
- [ ] AI citation monitoring: should the portal track whether AI systems (ChatGPT, Perplexity, Gemini, etc.) cite Yogananda correctly when quoting from portal content? Not surveillance — web mention monitoring to evaluate whether `llms.txt` citation guidance is effective. Could inform future citation guidance improvements. (ADR-081, Milestone 2b+)
