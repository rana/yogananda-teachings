## DES-061: Epistemic Data Boundary — Three-Phase Pipeline
...
Phase 2: EDITORIAL (Contentful — source of truth, ADR-010)
...
Phase 3: ENRICHMENT (Neon — derived cache + AI enrichment)
  ...
  3b. Chunk text by natural boundaries (ADR-048)
...
| Chunk boundaries | Algorithmic segmentation | Neon | ADR-048 algorithm output |
...
- **ADR-085** — Book ingestion pipeline (updated to reference this document)
