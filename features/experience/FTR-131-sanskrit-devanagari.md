...
- **Display:** Devanāgarī verses are preserved in `chunk_content` and rendered using Noto Sans Devanagari in the font stack. The Devanāgarī font loads from Arc 1 (not Milestone 5b) because the English-language Gita and Holy Science contain Devanāgarī — and because Hindi content is ingested in Arc 1 (FTR-011).
...
With Hindi *Autobiography of a Yogi* in Arc 1 (FTR-011), Devanāgarī transitions from supplemental verse blocks to a full-text reading experience. This requires typography treatment fundamentally different from occasional verse rendering:
