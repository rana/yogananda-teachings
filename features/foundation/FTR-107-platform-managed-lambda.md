...
summary: "AWS Lambda with EventBridge scheduling for batch operations: backups, ingestion, relations, email dispatch"
state: approved
domain: foundation
