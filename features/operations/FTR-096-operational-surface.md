...
| **Structured logs** | Search query patterns | Already logged (FTR-082). Zero-result queries → golden set candidates (FTR-037). Query language distribution → real demand data for FTR-011 prioritization | Milestone 1c |
