...
- **FTR-071** — Epistemic data boundary (where AI-derived data lives)
- **FTR-022** — Book ingestion pipeline (task assignments reference COG levels)
- **FTR-095** — Infrastructure and deployment (model provisioning via Bedrock)

## Notes

- **Origin:** FTR-038 (Cognitive Task Classification)
